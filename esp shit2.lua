...
local framework = {
    config = {
        player = {
            ...
            tool = false, -- Exclusive to players
            health = true, -- Exclusive to players and humanoids

            distance_limit = 350, -- It will skip calculation if the player is over this limit
            dead_check = true,
            fade = true
        },
        ...
        humanoid = {
            ...
            distance_limit = 2000, -- It will skip calculation if the humanoid is over this limit
        ...
        object = {
            ...
            distance_limit = 2000, -- It will skip calculation if the object is over this limit
            fade = true -- Makes it fade the farther away you are away from it
        },

        global_distance_limit = 450, -- It will skip calculation if the entity is over this limit
    },

    entities = {
        players = {game:GetService("Workspace").Players}, -- Guess what it's used for
